            ...
            <div class="baseForm" style="width: 1000px; height: auto;">
                ...
                <div class="baseFormBodyFlex" style="width: auto; height: auto; margin-bottom: 5px;">
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td colspan="4">
                                <telerik:RadTextBox ID="txtPOBody" runat="server" Resize="Vertical" TextMode="MultiLine" Skin="Silk" Width="100%" />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="4">
                                <telerik:RadTextBox ID="txtEmailBody" runat="server" Resize="Vertical" TextMode="MultiLine" Skin="Silk" Width="100%" />
                            </td>
                        </tr>
                    </table>
                </div>
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td style="text-align: left;" colspan="4">
                                <asp:Button ID="btnUpdateTC" runat="server"  BorderStyle="None" CssClass="buttonStyle" Text="Add"
                ...
                <div class="baseFormBodyFlex" style="width: auto; height: auto; margin-bottom: 5px;">
                    <div style="text-align: right; clear: both; width: 100%;">
                        <asp:Button ID="btnMailSend" runat="server" BorderStyle="None" CssClass="buttonStyle" Text="PO Mail Send" OnClick="btnMailSend_Click"></asp:Button>
