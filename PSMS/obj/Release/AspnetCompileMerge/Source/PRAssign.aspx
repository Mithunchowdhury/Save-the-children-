                    ...
                    <table style="width: 100%;">
                        ...
                        <tr>
                            <td colspan="2" style="text-align:right;">
                                ...
                                <asp:Button ID="btnSave" runat="server" BorderStyle="None" CssClass="buttonStyle" OnClick="btnSave_Click" Text="Assign PR" />
                            </td>
                            <td>&nbsp;</td>
                            <td style="text-align:right;">
                                <asp:Button ID="btnSendMail" runat="server" BorderStyle="None" CssClass="buttonStyle" OnClick="btnSendMail_Click" Text="Send EMail Note" />
                            </td>
                        </tr>
                    </table>
                </div>
