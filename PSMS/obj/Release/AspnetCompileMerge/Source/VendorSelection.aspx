            ...
            <div class="baseForm" style="width: auto; height: auto;">
                ...
                <div class="baseFormBodyFlex" style="width: auto; height: auto; margin-bottom: 5px;">
                    ...
                    <telerik:RadGrid ID="grdItemInfo" runat="server" AllowSorting="false" AutoGenerateColumns="false"
                        AllowPaging="False" AllowMultiRowSelection="true" GridLines="Both" Width="100%" Height="150px"
                ...
                <div class="baseFormBodyFlex" style="width: auto; height: auto; margin-bottom: 5px; margin-top: 5px;">
                    <table style="width: 50%">
                        ...
                        <tr style="align-items: baseline">
                            ...
                            <td style="width: 50%;">
                                <telerik:RadDatePicker ID="dtpPODate" runat="server" DateInput-DisplayDateFormat="dd/MM/yyyy" Skin="Silk" Width="100%">
                                    <Calendar runat="server">
                                        <SpecialDays>
                                            <telerik:RadCalendarDay Repeatable="Today" ItemStyle-BackColor="Bisque" />
                                        </SpecialDays>
                ...
                <div class="baseFormBodyFlex" style="width: auto; height: auto; margin-bottom: 5px; margin-top: 5px;">
                    <div style="text-align: right;">
                        <asp:Button ID="btnSave" runat="server"  BorderStyle="None" CssClass="buttonStyle" Text="Save" TabIndex="5" OnClick="btnSave_Click"></asp:Button>
