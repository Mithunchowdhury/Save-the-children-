            ...
            <div class="baseForm" style="width: auto; height: auto;">
                ...
                <div class="baseFormBodyFlex" style="width: auto; height: auto; margin-bottom: 5px;">
                    ...
                    <table style="width: 100%;">
                        ...
                        <tr style="align-items: baseline">
                            ...
                            <td>
                                <telerik:RadDatePicker ID="dtpDate" runat="server" DateInput-DisplayDateFormat="dd/MM/yyyy" TabIndex="8" Skin="Silk" Width="100%" OnSelectedDateChanged="dtpDate_SelectedDateChanged">
                        ...
                        <tr style="align-items: baseline">
                            ...
                            <td>
                                <telerik:RadDatePicker ID="dtpInvoiceDate" runat="server" DateInput-DisplayDateFormat="dd/MM/yyyy" TabIndex="11" Skin="Silk" Width="100%">
                                    <Calendar runat="server">
                                        <SpecialDays>
                                            <telerik:RadCalendarDay Repeatable="Today" ItemStyle-BackColor="Bisque" />
                                        </SpecialDays>
                        ...
                        <tr style="align-items: baseline">
                            ...
                            <td>
                                <telerik:RadDatePicker ID="dtpInvoiceReceivedDate" runat="server" DateInput-DisplayDateFormat="dd/MM/yyyy" TabIndex="17" Skin="Silk" Width="100%">
                                    <Calendar runat="server">
                                        <SpecialDays>
                                            <telerik:RadCalendarDay Repeatable="Today" ItemStyle-BackColor="Bisque" />
                                        </SpecialDays>
                ...
                <div class="baseFormBodyFlex" style="width: auto; height: auto; margin-bottom: 5px;">
                    <div style="text-align: right;">
                        ...
                        <asp:Button ID="btnForward" runat="server" Text="Forward for Payment" BorderStyle="None" CssClass="buttonStyle" OnClick="btnForward_Click"></asp:Button>
