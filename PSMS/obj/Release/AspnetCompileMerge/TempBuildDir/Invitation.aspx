            ...
            <div class="baseForm" style="width: 900px; height: auto;">
                        ...
                        <tr>
                            ...
                            <td style="width: 25%">
                                <telerik:RadDatePicker ID="dtpDate" runat="server" DateInput-DisplayDateFormat="dd/MM/yyyy"
                                    OnSelectedDateChanged="dtpDate_SelectedDateChanged" Skin="Silk" Width="100%">
                ...
                <div class="baseFormBodyFlex" style="width: auto; height: auto; margin-bottom: 5px;">
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td>
                                <telerik:RadDatePicker ID="dtpLastBidDate" DateInput-DisplayDateFormat="dd/MM/yyyy" runat="server" Width="100%" Skin="Silk">
                                    <Calendar runat="server">
                                        <SpecialDays>
                                            <telerik:RadCalendarDay Repeatable="Today" ItemStyle-BackColor="Bisque" />
                                        </SpecialDays>
                            ...
                            <td>
                                <telerik:RadTimePicker ID="tpWithin" runat="server" Width="100%" Skin="Silk">
                                </telerik:RadTimePicker>

                            </td>
                            <td>
                                <telerik:RadDatePicker ID="dtpDelivaryDate" DateInput-DisplayDateFormat="dd/MM/yyyy" runat="server" Width="100%" Skin="Silk">
                                    <Calendar runat="server">
                                        <SpecialDays>
                                            <telerik:RadCalendarDay Repeatable="Today" ItemStyle-BackColor="Bisque" />
                                        </SpecialDays>
                    ...
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td colspan="4" style="text-align: right">
                                <asp:Button ID="btnApprovalSend" runat="server" BorderStyle="None" CssClass="buttonStyle" Text="Send" OnClick="btnApprovalSend_Click"></asp:Button>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="baseFormBodyFlex" style="width: auto; height: auto; margin-bottom: 5px;">
                    <div style="text-align: right; clear: both; width: 100%;">
                        ...
                        <asp:Button ID="btnInvSend" runat="server" BorderStyle="None" CssClass="buttonStyle" Text="Send" OnClick="btnInvSend_Click"></asp:Button>
