...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel runat="server">
                    ...
                    <div class="baseFormBodyFlex" style="height: 985px">
                        ...
                        <div class="baseFormBodyFlex" style="height: 250px; margin-top: 5px;">
                            ...
                            <table style="width: 100%;">
                                <tr style="align-items: baseline">
                                    <td>
                                        <%--<telerik:RadAsyncUpload runat="server" ID="asyncUploadAttachment" 
                                            MultipleFileSelection="Automatic" Localization-Select="Browse..."
                                       ...
                                       <%-- <telerik:RadAsyncUpload runat="server" ID="UploadAttachment" PostbackTriggers="btnAttachFile" 
                                            TemporaryFileExpiration="00:20:00" MultipleFileSelection="Automatic" 
                                            Localization-Select="Browse..." HideFileInput="true" />--%>
        ...
        <Triggers>
            <asp:PostBackTrigger ControlID="grdFWs" /> 
            <asp:PostBackTrigger ControlID="rgdAttachment" />           
        </Triggers>
    </asp:UpdatePanel>
</asp:Content>
