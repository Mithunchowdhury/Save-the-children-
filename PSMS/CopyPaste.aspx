<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="CopyPaste.aspx.cs" Inherits="PSMS.CopyPaste" %>
            ...
            <div class="settingsForm" style="width:800px;">
                ...
                <div class="settingsFormBodyLeft" style="width:55%;">
                    <telerik:RadGrid ID="grd" runat="server" AutoGenerateColumns="False"
                        ...
                        CellSpacing="-1" GridLines="Both" Height="100%"  GroupPanelPosition="Top">  
                   ...
                   <tr>
                        ...
                        <tr>
                            <td>
                                ...
                                <telerik:RadTextBox ID="tbxUserName" runat="server" MaxLength="50" Width="100%"  />
                        ...
                        <tr>
                            <td>
                                <telerik:RadTextBox ID="tbxFullName" runat="server" MaxLength="100" Width="100%"  />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <telerik:RadTextBox ID="tbxStaffCode" runat="server" MaxLength="5" Width="100%"  />
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <telerik:RadComboBox ID="cbxGroups" runat="server" Width="100%" >
                              </telerik:RadComboBox>
                        ...
                        <tr>
                            <td>
                                <telerik:RadComboBox ID="cbxLocations" runat="server" Width="100%"  Filter="Contains" MarkFirstMatch="true">
                                </telerik:RadComboBox>
                            </td>
                        </tr>
                        <tr>
