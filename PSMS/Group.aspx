<%@ Page Title="" Language="C#" MasterPageFile="~/App.Master" AutoEventWireup="true" CodeBehind="Group.aspx.cs" Inherits="PSMS.Group" %>
            ...
            <div class="settingsForm" style="width:800px;">
                ...
                <div class="settingsFormBodyLeft" style="width:55%;">
                    <telerik:RadGrid ID="grd" runat="server" AutoGenerateColumns="False"
                        ...
                        OnNeedDataSource="grd_NeedDataSource" Height="100%" Width="100%" Skin="Metro">
                ...
                <div class="settingsFormBodyRight" style="width:35%;">
                    <table class="settingsEntryTable">
                        ...
                        <tr>
                            <td>
                                <telerik:RadTextBox ID="tbxDescription" runat="server" MaxLength="50" Resize="None" TextMode="MultiLine" Width="100%" Skin="Silk" />
                            </td>
                        </tr>
                        <tr>
                            <td>Active</td>
