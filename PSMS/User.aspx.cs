...
namespace PSMS
{
    public partial class User : System.Web.UI.Page
    {
        ...
        private bool Valid()
        {
            ...
            {
                am.Utility.ShowHTMLMessage(this.Page, "111", "Enter Login Name.");
                tbxUserName.Focus();
                return false;
            }
            if (tbxStaffCode.Text.Trim().Length <= 0)
            {
                am.Utility.ShowHTMLMessage(this.Page, "111", "Enter Staff Code.");
                tbxStaffCode.Focus();
                return false;
            }
            if (cbxGroups.SelectedValue == "0")
            {
                am.Utility.ShowHTMLMessage(Page, "111", "Select Group.");
                cbxGroups.Focus();
                return false;
            }
            if (cbxLocations.SelectedValue == "0")
            {
                am.Utility.ShowHTMLMessage(Page, "111", "Select Location.");
                cbxLocations.Focus();
                return false;
            }
